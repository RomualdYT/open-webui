...
app.state.config.FIRECRAWL_LOADER_ONLY_MAIN_CONTENT = FIRECRAWL_LOADER_ONLY_MAIN_CONTENT
app.state.config.FIRECRAWL_LOADER_PARSE_PDF = FIRECRAWL_LOADER_PARSE_PDF
app.state.config.FIRECRAWL_LOADER_MULTI_URL_MODE = FIRECRAWL_LOADER_MULTI_URL_MODE
app.state.config.FIRECRAWL_LOADER_PROXY_MODE = FIRECRAWL_LOADER_PROXY_MODE
app.state.config.FIRECRAWL_LOADER_MAX_AGE_MS = FIRECRAWL_LOADER_MAX_AGE_MS
app.state.config.FIRECRAWL_SEARCH_CONTENT_MODE = FIRECRAWL_SEARCH_CONTENT_MODE
