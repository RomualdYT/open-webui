...
FIRECRAWL_LOADER_MULTI_URL_MODE = PersistentConfig(
    'FIRECRAWL_LOADER_MULTI_URL_MODE',
    'rag.web.loader.firecrawl_multi_url_mode',
    os.environ.get('FIRECRAWL_LOADER_MULTI_URL_MODE', 'auto'),
)
...
FIRECRAWL_SEARCH_CONTENT_MODE = PersistentConfig(
    'FIRECRAWL_SEARCH_CONTENT_MODE',
    'rag.web.search.firecrawl_content_mode',
    os.environ.get('FIRECRAWL_SEARCH_CONTENT_MODE', 'search_and_scrape'),
)
